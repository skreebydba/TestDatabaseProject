...
GO
CREATE TRIGGER [Sales].[TR_Sales_Customers_DataLoad_Modify]
ON [Sales].[Customers]
AFTER INSERT, UPDATE
AS
BEGIN
    ...
    INSERT [Sales].[Customers_Archive]
    ...
    SELECT d.[CustomerID], d.[CustomerName], d.[BillToCustomerID], d.[CustomerCategoryID], d.[BuyingGroupID], d.[PrimaryContactPersonID], d.[AlternateContactPersonID], d.[DeliveryMethodID], d.[DeliveryCityID], d.[PostalCityID], d.[CreditLimit], d.[AccountOpenedDate], d.[StandardDiscountPercentage], d.[IsStatementSent], d.[IsOnCreditHold], d.[PaymentDays], d.[PhoneNumber], d.[FaxNumber], d.[DeliveryRun], d.[RunPosition], d.[WebsiteURL], d.[DeliveryAddressLine1], d.[DeliveryAddressLine2], d.[DeliveryPostalCode], d.[DeliveryLocation], d.[PostalAddressLine1], d.[PostalAddressLine2], d.[PostalPostalCode],d.[LastEditedBy],  d.[ValidFrom], i.[ValidFrom]
    FROM inserted AS i
...
GO
DENY SELECT
    ON [Sales].[Customers] ([PhoneNumber]) TO [permtest]
    AS [dbo];
